...
HD_PWD='F:/vivado_code/git/Verilog_advanced/ch5/ch5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Auto_LFSR_ALGO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Auto_LFSR_ALGO.tcl
